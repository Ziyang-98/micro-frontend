...
function createElement(appContent, strictStyleIsolation, scopedCSS, appName) {
  ...
  if (scopedCSS) {
    ...
    if (!attr) {
      appElement.setAttribute(_sandbox.css.QiankunCSSRewriteAttr, appName);
    }

    var styleNodes = appElement.querySelectorAll('style') || [];
    (0, _forEach2.default)(styleNodes, function (stylesheetElement) {
      _sandbox.css.process(appElement, stylesheetElement, appName);
    });
  }
      ...
      while (1) {
        switch (_context16.prev = _context16.next) {
          ...
          case 16:
            ...
            if (sandbox) {
              sandboxContainer = (0, _sandbox.createSandboxContainer)(appName, // FIXME should use a strict sandbox logic while remount, see https://github.com/umijs/qiankun/issues/518
