(function (global, factory) {
	 ...
	 * @since 2020-04-13
	 */
	var currentRunningSandboxProxy = null;
	            ...
	            if (scopedCSS) {
	              ...
	              if (linkElementUsingStylesheet) {
	                ...
	                stylesheetElement = convertLinkAsStyle(element, function (styleElement) {
	                  return process(mountDOM, styleElement, appName);
	                }, _fetch);
	                dynamicLinkAttachedInlineStyleMap.set(element, stylesheetElement);
	              } else {
	                process(mountDOM, stylesheetElement, appName);
	              }
	...
	var variableWhiteListInDev =  [// for react hot reload
	...
	function createFakeWindow(global) {
	  ...
	  Object.getOwnPropertyNames(global).filter(function (p) {
	    ...
	    if (descriptor) {
	      ...
	      if (p === 'top' || p === 'parent' || p === 'self' || p === 'window' || "development" === 'test' ) {
	        descriptor.configurable = true;
	        /*
	  ...
	  function ProxySandbox(name) {
	    ...
	    var proxy = new Proxy(fakeWindow, {
	      ...
	      get: function get(target, p) {
	        ...
	        if (p === 'top' || p === 'parent' || "development" === 'test' ) {
	...
	function createSandboxContainer(appName, elementGetter, scopedCSS, useLooseSandbox, excludeAssetFilter) {
	  ...
	  if (window.Proxy) {
	    sandbox = useLooseSandbox ? new SingularProxySandbox(appName) : new ProxySandbox(appName);
	  } else {
	...
	var _excluded = ["singular", "sandbox", "excludeAssetFilter"];
	...
	function _loadApp() {
	  _loadApp = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee16(app) {
	    ...
	    return regenerator.wrap(function _callee16$(_context16) {
	      while (1) {
	        switch (_context16.prev = _context16.next) {
	          case 0:
	            configuration = _args16.length > 1 && _args16[1] !== undefined ? _args16[1] : {};
	            lifeCycles = _args16.length > 2 ? _args16[2] : undefined;
	            ...
	            _configuration$singul = configuration.singular, singular = _configuration$singul === void 0 ? false : _configuration$singul, _configuration$sandbo = configuration.sandbox, sandbox = _configuration$sandbo === void 0 ? true : _configuration$sandbo, excludeAssetFilter = configuration.excludeAssetFilter, importEntryOpts = _objectWithoutProperties(configuration, _excluded); // get the entry html content and script executor
	            ...
	            parcelConfigGetter = function parcelConfigGetter() {
	              ...
	              var parcelConfig = {
	                ...
	                _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5() {
	                  ...
	                  var _ref6 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6(props) {
	                    return regenerator.wrap(function _callee6$(_context6) {
	                      while (1) {
	                        switch (_context6.prev = _context6.next) {
	                          case 0:
	                            return _context6.abrupt("return", mount(_objectSpread(_objectSpread({}, props), {}, {
	                ...
	                _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee7() {
	                ...
	                _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee9() {
	                ...
	                unmount: [/*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee11() {
	                  ...
	                  var _ref12 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee12(props) {
	                    return regenerator.wrap(function _callee12$(_context12) {
	                      while (1) {
	                        switch (_context12.prev = _context12.next) {
	                          case 0:
	                            return _context12.abrupt("return", unmount(_objectSpread(_objectSpread({}, props), {}, {
	                              container: appWrapperGetter()
	                            })));
	                ...
	                }(), unmountSandbox, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee13() {
	                ...
	                })), /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee14() {
	...
	function loadMicroApp(app, configuration, lifeCycles) {
	    ...
	    var _ref3 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4() {
	      ...
	      return regenerator.wrap(function _callee4$(_context4) {
	        while (1) {
	          switch (_context4.prev = _context4.next) {
	            case 0:
	              userConfiguration = configuration !== null && configuration !== void 0 ? configuration : _objectSpread(_objectSpread({}, frameworkConfiguration), {}, {
	                singular: false
	              });
	  ...
	  return C(memorizedLoadingFn, _objectSpread({
